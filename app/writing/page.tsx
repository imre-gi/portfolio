...
export const metadata: Metadata = {
  title: "Writing",
  description:
    "Notes on research, design, decision quality and the craft of working with evidence.",
};
  ...
  return (
    <article className="pb-24">
      <header className="container-wide pt-12 md:pt-16 pb-12 md:pb-16">
        <ChapterHeader
          number="INDEX · WRITING"
          title="Notes from the practice."
          lead="Long-form writing on research, design, decision quality and the craft of working with evidence. Updated when there's something to say — never to a schedule."
          as="h1"
        />
      </header>
          ...
          {live.map((w) => (
            <li key={w.slug} className="border-b border-rule">
              ...
              >
                ...
                <p className="md:col-span-2 t-mono text-ink-2">
                  {w.readingTime}
                </p>
      ...
      {drafts.length > 0 && (
        <section className="container-wide py-16">
          <p className="t-mono mb-6">DRAFTS · COMING SOON</p>
      ...
      {writings.length === 0 && (
        <div className="container-wide py-20">
          <p className="t-lead text-ink-2 max-w-2xl">
            Notes are coming. In the meantime, the case studies under
            <Link href="/work" className="inline-link mx-1">Work</Link>
            are written as long-form decision records.
          </p>
        </div>
      )}
    </article>
