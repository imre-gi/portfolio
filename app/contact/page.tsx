...
export const metadata = {
  title: "Contact — Imre Guaglianone",
  description: "Get in touch with Imre Guaglianone — Experience Designer, Researcher, Founder.",
};
    ...
    <div className="pt-32 pb-24 px-6 md:px-12 min-h-screen flex flex-col justify-between">
      <div className="max-w-[1400px] mx-auto w-full flex flex-col gap-20">
        ...
        <div>
          ...
          >
            Let&rsquo;s work<br />
            <span className="text-[#C8A96E]">together.</span>
          </h1>
        </div>
